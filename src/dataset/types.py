...
class BatchedViews(TypedDict, total=False):
    ...
    # Optional 3D-consistent instance IDs per pixel (0 can be used as ignore/background).
    instance_mask: Int64[Tensor, "batch _ _ _"]  # batch view height width
    # Optional valid pixel mask (e.g., from depth filtering).
    valid_mask: Bool[Tensor, "batch _ _ _"]  # batch view height width
